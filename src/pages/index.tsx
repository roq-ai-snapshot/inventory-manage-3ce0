  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless control with Inventory Management System - your ultimate solution for recording and managing all inventory details."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZlbnRvcnl8ZW58MHx8fHwxNjk4MjQ1MjQyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless control with Inventory Management System - your ultimate solution for recording and managing all inventory details.`}
            </Text>
            <Box
